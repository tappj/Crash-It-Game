...
(function (root, factory) {
  ...
  const MAPS = [
    ...
    M({
      ...
      planks: [{ x: 800, y: 330, w: 460, h: 26, angle: 0 }],
    ...
    M({
      ...
      planks: [{ x: 800, y: 430, w: 560, h: 26, angle: 0 }],
    ...
    M({
      ...
      planks: [{ x: 800, y: 295, w: 500, h: 26, angle: 0 }],
    ...
    M({
      ...
      planks: [
        { x: 430, y: 390, w: 480, h: 26, angle: -0.08 },
        { x: 1170, y: 390, w: 480, h: 26, angle: 0.08 },
      ],
